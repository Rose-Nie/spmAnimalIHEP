function IHEP_old_normalizationDTI(Template,SourceImage,ImagetoWrite)
% List of open inputs
...
%     inputs{2, crun} = cellstr(ImagetoWrite); % Old Normalise: Estimate & Write: Images to Write - cfg_files
    inputs{2, crun} = cellstr(ImagetoWrite); % Old Normalise: Estimate & Write: Images to Write - cfg_filess
