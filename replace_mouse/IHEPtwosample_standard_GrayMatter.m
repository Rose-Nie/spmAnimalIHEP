function IHEPtwosample_standard_GrayMatter(group1, name1, group2, name2,path_result)
% List of open inputs
...
Fullpath = fullfile(spm('Dir'),'toolbox', 'spmAnimalIHEP','replace_mouse','IHEPtwosample_standard_GrayMatter_job.m');
jobfile = {Fullpath};
