...
if ischar(params)
  switch params
   ...
   case 'basic_ui'
    ...
    o = pr_basic_ui1(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    
    o = pr_basic_ui2(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    
    o = pr_basic_ui3(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    
    o = pr_basic_ui4(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    
    o = pr_basic_ui5(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    o = pr_basic_ui6(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    o = pr_basic_ui7(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    o = pr_basic_ui8(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    o = pr_basic_ui9(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    o = pr_basic_ui10(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    
    o = pr_basic_ui11(others, varargin{:});
    if ~isempty(o), o = paint(o); end
    return
  end
