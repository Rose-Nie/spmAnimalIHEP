...
%     nbb_rat_xyz_xishu(:,2) = 8.25;
    nbb_rat_xyz_xishu(:,1) = 6;
    nbb_rat_xyz_xishu(:,2) = 6; %修改为树鼩的常系数
    % 将扩充后的矩阵与系数矩阵点乘
...
%     mtp = [-0.0173 -0.001 0; 0 -0.0177 0; -0.0033 -0.0213 0.24; 8.2266 12.7566 -15.9579];
    mtp = [0.0214 0.0001 0.0000; -0.0000 -0.0218 -0.0001; 0.0003  -0.0010 0.2668; -11.5062 17.2171 -16.982]; %修改为树鼩的A矩阵
