...
%==========================================================================
    ...
    %======================================================================
        ...
        if nargin<4
            ...
            ptm = [12.2441   -0.0633    0.1213;   -0.3300  -10.8312   -0.3406;   -0.1250   -1.6604   13.5262;   98.7396  130.9675   45.7390];
            ...
            M = [-0.8 0 0 97.3000; 0 0.8000 0 -80.4000; 0 0 0.8 -79.7000; 0 0 0 1.000];
            clear xyz;
