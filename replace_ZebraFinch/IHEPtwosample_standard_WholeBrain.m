function IHEPtwosample_standard_WholeBrain(group1, name1, group2, name2,path_result)
% List of open inputs
...
Fullpath = fullfile(spm('Dir'),'toolbox', 'spmAnimalIHEP','replace_ZebraFinch','IHEPtwosample_standard_WholeBrain_job.m');
jobfile = {Fullpath};
