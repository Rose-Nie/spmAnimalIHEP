...
Matrix_mouse = [159.2  117.6000  120];
ORG_NBB = [97.3 80.4 79.7];
pathre_backup = '';
...
%     resultname = strcat(str_indi,file_res(k,:).name);
    ...
    RXTEMP1 = ORG_NBB(1):(0-voxelsize_nbb(1)):0.4;
    RYTEMP1 = ORG_NBB(2):(0-voxelsize_nbb(2)):0.4;
    RZTEMP1 = ORG_NBB(3):(0-voxelsize_nbb(3)):0.4;
    RXTEMP2 = ORG_NBB(1):voxelsize_nbb(1):Matrix_mouse(1);
    RYTEMP2 = ORG_NBB(2):voxelsize_nbb(2):Matrix_mouse(2);
    RZTEMP2 = ORG_NBB(3):voxelsize_nbb(3):Matrix_mouse(3);
    
    Matrix_resultimg_x = [RXTEMP1(end:-1:1) RXTEMP2(2:end)]/0.8;
    Matrix_resultimg_y = [RYTEMP1(end:-1:1) RYTEMP2(2:end)]/0.8;
    Matrix_resultimg_z = [RZTEMP1(end:-1:1) RZTEMP2(2:end)]/0.8;
...
%             roiimg(temp1) = 1;
            ...
            temp1111 = find(roiimgtemp>0);
            roiimgtemp(temp1111) = 1;
