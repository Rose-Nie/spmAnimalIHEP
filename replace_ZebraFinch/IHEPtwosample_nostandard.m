function IHEPtwosample_nostandard(group1, name1, group2, name2,path_result)
% List of open inputs
...
Fullpath = fullfile(spm('Dir'),'toolbox', 'spmAnimalIHEP','replace_ZebraFinch','IHEPtwosample_nostandard_job.m');
jobfile = {Fullpath};
